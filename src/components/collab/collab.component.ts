import { CollaborateModule, CollaborateConfig, UserInfo } from '@textbus/collaborate'
...
const userInfo: UserInfo = { username: username, color: createColor(), id: Math.random().toString() }
// 实例化协作模块
const collaborateConfig: CollaborateConfig = {
  url: 'ws://localhost:1234',
  roomName: 'textbus-demo',
  userinfo: userInfo
}
const collaborateModule = new CollaborateModule(collaborateConfig)

export { collaborateModule, userInfo }
